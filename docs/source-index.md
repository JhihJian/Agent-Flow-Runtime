...
| `ProcessCommandExecutor` | 类 | 是 | [src/runtime.ts:156-187](../src/runtime.ts#L156) |
| `ProcessCommandExecutor.execute` | 方法 | 是 | [src/runtime.ts:157-186](../src/runtime.ts#L157) |
| `AgentRunModel` | 类 | 是 | [src/runtime.ts:189-292](../src/runtime.ts#L189) |
| `AgentRunModel.start` | 方法 | 是 | [src/runtime.ts:197-221](../src/runtime.ts#L197) |
| `AgentRunModel.executeNode` | 方法 | 是 | [src/runtime.ts:223-280](../src/runtime.ts#L223) |
| `AgentRunModel.getNodeSession` | 方法 | 是 | [src/runtime.ts:282-284](../src/runtime.ts#L282) |
| `AgentRunModel.end` | 方法 | 是 | [src/runtime.ts:286-291](../src/runtime.ts#L286) |
| `FlowCoordinator` | 类 | 是 | [src/runtime.ts:294-695](../src/runtime.ts#L294) |
| `FlowCoordinator.run` | 方法 | 是 | [src/runtime.ts:312-336](../src/runtime.ts#L312) |
| `FlowCoordinator.resume` | 方法 | 是 | [src/runtime.ts:339-415](../src/runtime.ts#L339) |
| `FlowCoordinator.failInterruptedCommand` | 方法 | 否 | [src/runtime.ts:417-427](../src/runtime.ts#L417) |
| `FlowCoordinator.continueRun` | 方法 | 否 | [src/runtime.ts:429-561](../src/runtime.ts#L429) |
| `FlowCoordinator.executeParallel` | 方法 | 否 | [src/runtime.ts:563-618](../src/runtime.ts#L563) |
| `FlowCoordinator.executeNode` | 方法 | 否 | [src/runtime.ts:620-686](../src/runtime.ts#L620) |
| `FlowCoordinator.destination` | 方法 | 否 | [src/runtime.ts:688-694](../src/runtime.ts#L688) |
| `renderAgentPrompt` | 函数 | 否 | [src/runtime.ts:697-708](../src/runtime.ts#L697) |
| `clone` | 函数 | 否 | [src/runtime.ts:710-712](../src/runtime.ts#L710) |
...
| `NodeRunRecord` | 接口 | 是 | [src/types.ts:126-135](../src/types.ts#L126) |
| `ParallelRoundRecord` | 接口 | 是 | [src/types.ts:137-142](../src/types.ts#L137) |
| `FlowRunRecord` | 接口 | 是 | [src/types.ts:144-160](../src/types.ts#L144) |
| `RunStore` | 接口 | 是 | [src/types.ts:162-171](../src/types.ts#L162) |
