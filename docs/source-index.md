...
| 符号 | 类别 | 外部可见 | 位置 |
| --- | --- | --- | --- |
| `FlowObservabilityWebRequestContext` | 接口 | 是 | [src/flow-observability-web.ts:38-40](../src/flow-observability-web.ts#L38) |
| `FlowObservabilityWebAuthorizer` | 接口 | 是 | [src/flow-observability-web.ts:42-52](../src/flow-observability-web.ts#L42) |
| `FlowObservabilityWebHostOptions` | 接口 | 是 | [src/flow-observability-web.ts:54-72](../src/flow-observability-web.ts#L54) |
| `FlowObservabilityWebHost` | 类 | 是 | [src/flow-observability-web.ts:74-580](../src/flow-observability-web.ts#L74) |
| `FlowObservabilityWebHost.start` | 方法 | 是 | [src/flow-observability-web.ts:127-156](../src/flow-observability-web.ts#L127) |
| `FlowObservabilityWebHost.close` | 方法 | 是 | [src/flow-observability-web.ts:158-168](../src/flow-observability-web.ts#L158) |
| `FlowObservabilityWebHost.handle` | 方法 | 否 | [src/flow-observability-web.ts:170-211](../src/flow-observability-web.ts#L170) |
| `FlowObservabilityWebHost.establishSession` | 方法 | 否 | [src/flow-observability-web.ts:213-227](../src/flow-observability-web.ts#L213) |
| `FlowObservabilityWebHost.renderPage` | 方法 | 否 | [src/flow-observability-web.ts:229-231](../src/flow-observability-web.ts#L229) |
| `FlowObservabilityWebHost.handleApi` | 方法 | 否 | [src/flow-observability-web.ts:233-370](../src/flow-observability-web.ts#L233) |
| `FlowObservabilityWebHost.canReadRun` | 方法 | 否 | [src/flow-observability-web.ts:372-380](../src/flow-observability-web.ts#L372) |
| `FlowObservabilityWebHost.resolveFlowDefinition` | 方法 | 否 | [src/flow-observability-web.ts:382-401](../src/flow-observability-web.ts#L382) |
| `FlowObservabilityWebHost.openObservation` | 方法 | 否 | [src/flow-observability-web.ts:403-461](../src/flow-observability-web.ts#L403) |
| `FlowObservabilityWebHost.isAuthenticated` | 方法 | 否 | [src/flow-observability-web.ts:463-468](../src/flow-observability-web.ts#L463) |
| `FlowObservabilityWebHost.runtime` | 方法 | 否 | [src/flow-observability-web.ts:470-472](../src/flow-observability-web.ts#L470) |
| `FlowObservabilityWebHost.writeSse` | 方法 | 否 | [src/flow-observability-web.ts:474-480](../src/flow-observability-web.ts#L474) |
| `FlowObservabilityWebHost.publishSse` | 方法 | 否 | [src/flow-observability-web.ts:482-491](../src/flow-observability-web.ts#L482) |
| `FlowObservabilityWebHost.writeHtml` | 方法 | 否 | [src/flow-observability-web.ts:493-506](../src/flow-observability-web.ts#L493) |
| `FlowObservabilityWebHost.writeJavaScript` | 方法 | 否 | [src/flow-observability-web.ts:508-518](../src/flow-observability-web.ts#L508) |
| `FlowObservabilityWebHost.writeCss` | 方法 | 否 | [src/flow-observability-web.ts:520-530](../src/flow-observability-web.ts#L520) |
| `FlowObservabilityWebHost.writeLibraryAsset` | 方法 | 否 | [src/flow-observability-web.ts:532-554](../src/flow-observability-web.ts#L532) |
| `FlowObservabilityWebHost.writeJson` | 方法 | 否 | [src/flow-observability-web.ts:556-567](../src/flow-observability-web.ts#L556) |
| `FlowObservabilityWebHost.writeText` | 方法 | 否 | [src/flow-observability-web.ts:569-579](../src/flow-observability-web.ts#L569) |
| `WebRunSummary` | 接口 | 否 | [src/flow-observability-web.ts:582-594](../src/flow-observability-web.ts#L582) |
| `toWebRunSummary` | 函数 | 否 | [src/flow-observability-web.ts:596-610](../src/flow-observability-web.ts#L596) |
| `toWebRunHistory` | 函数 | 否 | [src/flow-observability-web.ts:612-665](../src/flow-observability-web.ts#L612) |
| `toWebFlowDefinition` | 函数 | 否 | [src/flow-observability-web.ts:667-677](../src/flow-observability-web.ts#L667) |
| `toWebEvidence` | 函数 | 否 | [src/flow-observability-web.ts:679-691](../src/flow-observability-web.ts#L679) |
| `toWebEvent` | 函数 | 否 | [src/flow-observability-web.ts:693-711](../src/flow-observability-web.ts#L693) |
| `summarize` | 函数 | 否 | [src/flow-observability-web.ts:713-716](../src/flow-observability-web.ts#L713) |
| `isLoopbackHost` | 函数 | 否 | [src/flow-observability-web.ts:718-720](../src/flow-observability-web.ts#L718) |
| `readJson` | 函数 | 否 | [src/flow-observability-web.ts:722-733](../src/flow-observability-web.ts#L722) |
