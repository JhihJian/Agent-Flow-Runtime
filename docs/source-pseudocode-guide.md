...
**源码：** [src/runtime.ts:499-538](../src/runtime.ts#L499)，`驱动一次运行`
<!-- /source-guide:location:coordinator-run -->
...
**源码：** [src/runtime.ts:853-875](../src/runtime.ts#L853)，`执行单个节点`
<!-- /source-guide:location:execute-node -->
...
**源码：** [src/runtime.ts:764-851](../src/runtime.ts#L764)，`执行并行分支`
<!-- /source-guide:location:execute-parallel -->
...
**源码：** [src/runtime.ts:397-454](../src/runtime.ts#L397)，`管理 Agent 节点`
<!-- /source-guide:location:agent-execute-node -->
